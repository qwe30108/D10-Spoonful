            ...
            <div className='offcanvas-body'>
              <ul className='navbar-nav justify-content-end justify-content-center-lg flex-grow-1 pe-3 my-4'>
                <li className='nav-item me-4 mb-4 my-lg-auto'>
                  <Link className='nav-link text-primary-950' aria-current='page' to='/news'>
                    最新消息
                  </Link>
                </li>
                <li className='nav-item me-4 mb-4 my-lg-auto'>
                  <Link className='nav-link text-primary-950' href='search.html'>
                    檢索頁面
                  </Link>
                </li>
                <li className='nav-item me-4 mb-4 my-lg-auto'>
                ...
                {!isAuth ? (
                  ...
                  <div className='dropdown'>
                    <button
                      ...
                      aria-expanded='false'
                    >
                      <img src='src\assets\images\user.png' className='userimg me-1' alt='會員圖片' />
                      {/* 使用者姓名 */}
                    </button>
                    <ul className='dropdown-menu'>
                      <li>
                        <Link className='dropdown-item text-primary-950' to='#'>
                          個人資料
                        </Link>
                      </li>
                      <li>
                        <Link className='dropdown-item text-primary-950' to='blacklistFavorites'>
                          我的黑名單/喜愛清單
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <a className='dropdown-item text-primary-950' href='#' onClick={() => logOut()}>
                          登出
                        </a>
                      </li>
                    </ul>
