  ...
  return (
    <>
      {reviews.map((review, index) => (
        <div className='comment-card py-md-9 px-md-6 pt-4 border-bottom' key={index}>
          <div className='row align-items-center'>
            <div className='col-md-5'>
              <img
                src={review.images[0] || `${import.meta.env.BASE_URL}assets/images/webp-images/no-image.webp`}
    ...
    <>
      ...
      <div className='info-left col-lg-6 mt-4 mt-md-9'>
        ...
        <div className='d-none d-md-flex justify-content-start mt-5 thumb-row'>
          {dish.images.map((image, index) => (
            <img src={image} className='thumb' data-bs-target='#foodCarousel' data-bs-slide-to={index} key={index} />
          ))}
        </div>
      </div>
      ...
      <div className='info-right col-lg-6 mt-9'>
        <div className='meals-title d-flex justify-content-between'>
          <h1 className='info-title h2 fs-md-1 text-primary-950'>{dish.title}</h1>
