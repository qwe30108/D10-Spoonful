      ...
      <div className='what-to-eat mx-auto'>
        ...
        <div className='what-to-eat-cards'>
          {foodCategories.map((item) => (
            <Link key={item.title} className='card' to={`/searchResult?type=${item.title}`}>
              <img
              ...
              <div className='col-md-4' key={dish.id}>
                <div className='card border-0 position-relative overflow-hidden'>
                  <div className='ratio ratio-4x3'>
                    <img src={dish.images[0]} className='card-img' alt={dish.title} />
                  </div>
                  ...
                  <Link to={`/mealsDetails/${dish.id}`} className='stretched-link'></Link>
                </div>
                <div className='d-flex justify-content-start mt-3'>
                  ...
                  <p className='text-primary-950 pt-1 mb-5 mb-md-9'>{dish.tags.join(' / ')}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            {latestDishes.map((dish) => (
              <SwiperSlide key={dish.id}>
                <div className='card new-meals-card p-4 rounded-4 shadow-sm h-100'>
                  <img className='rounded-3 w-100 new-meals-img' src={dish.images[0]} alt={dish.title} />
