          ...
          <div className='row'>
            <div className='col-lg-6'>
              ...
              <div className='mb-4 d-flex flex-column'>
                ...
                <div>
                  <input type='text' className='form-control rounded-pill' id='title' placeholder='請輸入餐點' />
                </div>
              </div>
              <div className='mb-4 d-flex flex-column'>
                ...
                <div>
                  <div className='d-flex flex-wrap gap-2 mb-3'>
                    <div className='me-4'>
                      <input type='checkbox' className='btn-check' id='spring-onion' autoComplete='off' />
                      <label
                    ...
                    <div className='me-4'>
                      <input type='checkbox' className='btn-check' id='garlic' autoComplete='off' />
                      <label className='btn btn-outline-primary-200 rounded-pill text-primary-900' htmlFor='garlic'>
                        <svg
                          width='16'
                          height='16'
                          viewBox='0 0 24 24'
                    ...
                    <div className='me-4'>
                      <input type='checkbox' className='btn-check' id='cilantro' autoComplete='off' />
                      <label className='btn btn-outline-primary-200 rounded-pill text-primary-900' htmlFor='cilantro'>
                        <svg
                          xmlns='http://www.w3.org/2000/svg'
                          width='16'
                          height='16'
                    ...
                    <div className='me-4'>
                      ...
                      <label className='btn btn-outline-primary-200 rounded-pill text-primary-900' htmlFor='tomato'>
                        <svg
                          xmlns='http://www.w3.org/2000/svg'
                          width='16'
                          height='16'
                    ...
                    <div className='me-4 d-flex'>
                      <label className='cursor-pointer mb-3'>
                        <input type='checkbox' id='other-check' className='d-none' onChange={toggleOtherInput} />
                        <div className='btn btn-outline-primary-200 rounded-pill'>
                          <span className='text-xs font-medium text-primary-900'>其他</span>
                        </div>
                      </label>
                    </div>
                  </div>
                ...
                <div className='d-flex flex-column flex-lg-row cursor-pointer'>
                  <div className='form-check form-check-inline px-4 pt-4 mt-4 rounded '>
                    <input
                      ...
                      value='customized'
                    />
                    <label className='form-check-label ms-2' htmlFor='customized'>
                  ...
                  <div className='form-check form-check-inline px-4 pt-4 mt-4 rounded '>
                    <input
                      ...
                      value='no-customized'
                    />
                    <label className='form-check-label ms-2' htmlFor='no-customized'>
